...
local default = function(parentType)
  local defaults = {
    ...
    textureTexture = "Interface\\Addons\\M33Auras\\PowerAurasMedia\\Auras\\Aura3",
...
M33Auras.RegisterSubRegionType("subtexture", L["Texture"], supports, create, modify, onAcquire, onRelease, default, nil, properties)

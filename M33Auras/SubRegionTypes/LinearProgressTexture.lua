...
local default = function(parentType)
  local defaults = {
    ...
    linearTextureTexture = "Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_FullWhite",
...
M33Auras.RegisterSubRegionType("sublineartexture", L["Linear Texture"], supports, create, modify, onAcquire, onRelease,

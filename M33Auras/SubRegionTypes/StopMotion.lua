...
local default = function(parentType)
  local defaults = {
    ...
    stopmotionTexture = "Interface\\AddOns\\M33Auras\\Media\\Textures\\stopmotion",
  ...
  if C_AddOns.IsAddOnLoaded("M33AurasStopMotion") then
    defaults.stopmotionTexture = "Interface\\AddOns\\M33AurasStopMotion\\Textures\\IconOverlays\\ArcReactor"
...
M33Auras.RegisterSubRegionType("substopmotion", L["Stop Motion"], supports, create, modify, onAcquire, onRelease, default, nil, properties)

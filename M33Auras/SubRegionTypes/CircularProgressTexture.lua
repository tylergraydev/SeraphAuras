...
local default = function(parentType)
  local defaults = {
    ...
    circularTextureTexture = "Interface\\AddOns\\M33Auras\\Media\\Textures\\square_border_5px.tga",
...
M33Auras.RegisterSubRegionType("subcirculartexture", L["Circular Texture"], supports, create, modify, onAcquire, onRelease,

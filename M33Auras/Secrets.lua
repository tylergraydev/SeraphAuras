...
local function HandleEvent(_, event, ...)
  ...
  if secretState ~= newSecretState then
    ...
    --   M33Auras.prettyPrint("secret state changed:", newSecretState, "on event:", event)
    -- end
...
function M33Auras.IsSecretStateActive()
  return secretState
end
...
--     return false
--   end
--   M33Auras.DoesAddonRestrictionsActive = DoesAddonRestrictionsActive
-- end

...
https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000La prise en charge des événements COMBAT_LOG_EVENT_UNFILTERED non filtrés est obsolète|r Les événements COMBAT_LOG_EVENT_UNFILTERED sans filtre sont désactivés, car ils nuisent fortement aux performances. Plus d'informations : https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[A detailed overview of your auras and M33Auras systems
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = [=[Cannot change secure frame in combat lockdown. Find more information:
...
L["Copper"] = "Copper"
--[[Translation missing --]]
L["Could not load M33Auras Archive, the addon is %s"] = "Could not load M33Auras Archive, the addon is %s"
L["Count"] = "Nombre"
...
L["Malformed M33Auras link"] = "Lien M33Auras mal formé"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
L["Using M33Auras.clones is deprecated. Use M33Auras.GetRegion(id, cloneId) instead."] = "L'utilisation de M33Auras.clones est obsolète. Utilisez plutôt M33Auras.GetRegion(id, cloneId)."
L["Using M33Auras.regions is deprecated. Use M33Auras.GetRegion(id) instead."] = "L'utilisation de M33Auras.regions est obsolète. Utilisez plutôt M33Auras.GetRegion(id)."

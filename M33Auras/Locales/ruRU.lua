...
-- function M33Auras.LoadLocale_ruRU()


--@localization(locale="ruRU", format="lua_additive_table", namespace="M33Auras", handle-subnamespaces="none")@
-- M33Auras
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "Невозможно изменить защищённый кадр во время боя. Подробная информация на странице: https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
...
https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events]=] ] = [=[Использование события COMBAT_LOG_EVENT_UNFILTERED без фильтра не рекомендуется, поскольку это очень затратно с точки зрения производительности. Подробная информация на странице:
...
L["Could not load M33Auras Archive, the addon is %s"] = "Не удалось загрузить M33Auras Archive. Причина - %s"
L["Count"] = "Количество"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "Ошибка при возвращении в пул клона индикации %s, поскольку кадр защищён. Советуем удалить эту индикацию. Подробная информация на странице: https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
L["Error decoding."] = "Ошибка декодирования"
L["Error decompressing"] = "Ошибка распаковки"
L["Error decompressing. This doesn't look like a M33Auras import."] = "Ошибка распаковки. Это не похоже на строку импорта M33Auras"
...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/M33Auras!"] = "Если вам необходима дополнительная помощь, пожалуйста, откройте запрос на GitHub или посетите наш сервер в Discord по адресу https://discord.gg/M33Auras."
...
L["Malformed M33Auras link"] = "Неверная ссылка M33Auras"
L["Malygos"] = "Малигос"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
L["Options could not be loaded, the addon is %s"] = "Не удалось загрузить M33Auras Options. Причина - %s"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = [=[Обнаружен защищённый кадр. Подробная информация на странице:
...
L["True"] = "Истина"
L["Trying to repair broken conditions in %s likely caused by a M33Auras bug."] = "Попытка восстановить поврежденные условия в индикации %s, причиной которых стала ошибка аддона."
L["Twilight Lord Kelris"] = "Повелитель сумрака Келрис"
L["Twin Emperors"] = "Императоры-близнецы"
L["Type"] = "Тип"
L["Ulduar"] = "Ульдуар"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to m33shoq."] = "Невозможно модернизировать ауру '%s'. Вероятно, это связано с повреждением данных или неудачным перемещением. Сообщите об этом команде M33Auras."
...
L["Using M33Auras.clones is deprecated. Use M33Auras.GetRegion(id, cloneId) instead."] = "M33Auras.clones объявлено устаревшим. Используйте функцию M33Auras.GetRegion(id, cloneId)."
L["Using M33Auras.regions is deprecated. Use M33Auras.GetRegion(id) instead."] = "M33Auras.regions объявлено устаревшим. Используйте функцию M33Auras.GetRegion(id)."
...
L["M33Auras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "M33Auras (встроенный):  63:42 | 3:07 | 10 | 2.4"
L[ [=[M33Auras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[M33Auras обнаружил, что версия аддона была понижена (осуществлен downgrade). Ваши индикации могут перестать работать должным образом.
...
L["M33Auras has encountered an error during the login process. Please report this issue at https://github.com/m33shoq/M33Auras/issues/new."] = "Во время процесса входа в игру возникла ошибка. Пожалуйста, сообщите об этой проблеме по адресу https://github.com/m33shoq/M33Auras/issues/new."
L["M33Auras Profiling"] = "Профилирование M33Auras"
L["M33Auras Profiling Report"] = "Отчёт профилирования"
L["M33Auras Version: %s"] = "Версия M33Auras: %s"
L["Weapon"] = "Оружие"
...
L["Writing to the M33Auras table is not allowed."] = "Запись в таблицу M33Auras запрещена."

...
https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000不再支持未过滤的 COMBAT_LOG_EVENT_UNFILTERED|r 未经过滤的 COMBAT_LOG_EVENT_UNFILTERED 已被禁用，因为它对性能影响很大。更多信息：https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[一个包括你的光环和M33Auras系统的详细信息。
如果你需要帮助，复制整个文本到M33Auras Discord。]=]
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "无法在战斗中更改安全框架。请查阅：https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
...
L["Copper"] = "铜"
L["Could not load M33Auras Archive, the addon is %s"] = "无法载入M33Auras Archive：%s"
L["Count"] = "计数"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "错误：'%s'创建了一个安全克隆。我们建议删除此光环。请查阅：https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
L["Error decoding."] = "解码错误。"
L["Error decompressing"] = "解压错误。"
L["Error decompressing. This doesn't look like a M33Auras import."] = "解压错误。这不像一个M33Auras导入字符串。"
...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/M33Auras!"] = "如果你需要进一步的协助，请在 GitHub 上提交工单或是访问我们的 Discord：https://discord.gg/M33Auras！"
L["Ignore Dead"] = "忽略已死亡"
...
L["Malformed M33Auras link"] = "错误的 M33Auras 链接"
L["Manual"] = "手动"
L["Manual Icon"] = "手动图标"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "检测到安全框架。请查阅：https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
L["Select Frame"] = "选择框体"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the M33Auras Discord server for help."] = "此过滤器已经被移动到位置过滤器。修改你的光环以使用新的位置过滤器，或者加入M33Auras Discord寻求帮助。"
...
L["True"] = "真"
L["Trying to repair broken conditions in %s likely caused by a M33Auras bug."] = "正在尝试修复由M33Auras的Bug导致的，%s的损坏条件。"
L["Twin Emperors"] = "双子皇帝"
L["Type"] = "类型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to m33shoq."] = "无法现代化光环'%s'。这个可能是因为数据错误或者升级流程错误，请报告给M33Auras团队。"
L["Unaffected"] = "未受影响"
L["Undefined"] = "未定义"
L["Unholy"] = "邪恶"
...
L["Using M33Auras.clones is deprecated. Use M33Auras.GetRegion(id, cloneId) instead."] = "M33Auras.clones已被弃用。请使用M33Auras.GetRegion(id, cloneId)代替。"
L["Using M33Auras.regions is deprecated. Use M33Auras.GetRegion(id) instead."] = "M33Auras.regions已被弃用。请使用M33Auras.GetRegion(id)代替。"
...
L["M33Auras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "M33Auras内置格式 （63:42 | 3:07 | 10 | 2.4）"
L["M33Auras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/M33Auras."] = "M33Auras 检测到了空的设置。如果这是意外情况，请在 https://discord.gg/M33Auras 上寻求帮助。"
L[ [=[M33Auras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[M33Auras检测到它的版本已被降低。
已保存的光环可能无法再正常工作。
是否要运行|cffff0000实验性|r修复工具？运行后将会丢失上次数据库升级后的所有改动。
上次升级：%s

|cffff0000在点击此按钮之前，你应该备份你的WTF文件夹。|r]=]
L["M33Auras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "M33Auras 正在创建您的光环的回滚快照。如果出现问题，此快照将允许恢复到光环的当前状态。此过程在其完成前可能会导致您的帧率下降。"
L["M33Auras Profiling"] = "M33Auras性能分析"
L["M33Auras Profiling Report"] = "M33Auras性能分析报告"
...
L["Writing to the M33Auras table is not allowed."] = "写入M33Auras表是不被允许的。"
L["X-Offset"] = "X 偏移"
L["Yell"] = "大喊"
L["Y-Offset"] = "Y 偏移"

...
https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트의 지원은 중단됐습니다|r 필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트는 성능 소모가 심해 사용할 수 없습니다. 자세한 정보: https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[당신의 위크오라와 M33Auras 시스템 전반에 대한 상세 정보입니다
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = [=[전투 중에는 보안 프레임을 변경할 수 없습니다. 자세한 정보:
...
L["Copper"] = "코퍼"
L["Could not load M33Auras Archive, the addon is %s"] = "M33Auras Archive를 불러올 수 없습니다. 애드온이 %s 상태입니다"
L["Count"] = "개수"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = [=['%s' 오류가 보안 요소의 복사본을 생성했습니다. 이 위크오라는 삭제할 것을 권장합니다. 자세한 정보:
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=]
L["Error decoding."] = "디코딩 오류입니다."
L["Error decompressing"] = "압축 해제 오류"
L["Error decompressing. This doesn't look like a M33Auras import."] = "압축을 푸는 중 오류가 발생했습니다. M33Auras 가져오기 문자열이 아닙니다."
...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/M33Auras!"] = "더 많은 도움이 필요하다면 GitHub에서 티켓을 열거나 저희 Discord (https://discord.gg/M33Auras)를 방문해 주세요!"
L["Ignore Dead"] = "죽음 무시"
...
L["Malformed M33Auras link"] = "잘못된 M33Auras 링크"
L["Manual"] = "수동 설정"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = [=[보안 프레임이 감지됐습니다. 자세한 정보:
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=]
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the M33Auras Discord server for help."] = "이 필터는 위치 활성 조건으로 이전됐습니다. 새로운 위치 활성 조건을 사용하려면 위크오라를 수정하시고 잘 모르겠으면 M33Auras Discord 서버에 접속해서 도움을 요청하세요."
...
L["True"] = "참"
L["Trying to repair broken conditions in %s likely caused by a M33Auras bug."] = "%s에서 M33Auras 버그로 인해 망가진 조건 복구를 시도중입니다."
L["Twin Emperors"] = "쌍둥이 제왕"
L["Type"] = "종류"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to m33shoq."] = "'%s' 위크오라를 현대화할 수 없습니다. 데이터 오염이나 마이그레이션에 문제가 있는 것 같습니다. 이 내역을 M33Auras 팀에 제보해 주세요."
...
L["Using M33Auras.clones is deprecated. Use M33Auras.GetRegion(id, cloneId) instead."] = "M33Auras.clones는 더이상 사용할 수 없습니다. M33Auras.GetRegion(id, cloneId)를 사용하세요."
L["Using M33Auras.regions is deprecated. Use M33Auras.GetRegion(id) instead."] = "M33Auras.regions는 더이상 사용할 수 없습니다. M33Auras.GetRegion(id)를 사용하세요."
...
L["M33Auras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "M33Auras 내장 (63:42 | 3:07 | 10 | 2.4)"
L["M33Auras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/M33Auras."] = "M33Auras가 빈 설정을 감지했습니다. 갑자기 발생한 것이라면 https://discord.gg/M33Auras에서 도움을 요청하세요."
L[ [=[M33Auras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[M33Auras가 다운그레이드를 감지했습니다.
...
L["Writing to the M33Auras table is not allowed."] = "M33Auras 테이블에 작성하는 행위는 허용되지 않습니다."
L["X-Offset"] = "X-위치 조정"
L["Yell"] = "외침"
L["Y-Offset"] = "Y-위치 조정"

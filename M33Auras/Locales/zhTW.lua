...
https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000已經不再支援未過濾的 COMBAT_LOG_EVENT_UNFILTERED|r 因為非常耗效能，已停用沒有過濾程式的 COMBAT_LOG_EVENT_UNFILTERED。更多資訊請看: https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "您的光環和M33Auras系統的詳細概述 如果您需要協助，請將全文複製到Weakaura的Discord。"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "無法在戰鬥鎖定中更改安全框架。查詢更多資訊：https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
...
L["Copper"] = "銅"
L["Could not load M33Auras Archive, the addon is %s"] = "無法載入M33Auras Archive，此插件為 %s"
L["Count"] = "數量"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "錯誤 '%s' 創建了一個安全複製品。我們建議刪除光環。更多訊息：https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
L["Error decoding."] = "解碼時出錯。"
L["Error decompressing"] = "解壓縮時出錯"
L["Error decompressing. This doesn't look like a M33Auras import."] = "解壓縮時出錯，這看起來不像是 M33Auras 的匯入字串。"
...
L["Id"] = "Id"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/M33Auras!"] = "如果你需要其他協助，請在 GitHub 新增問題，或拜訪我們的 Discord https://discord.gg/M33Auras!"
L["Ignore Dead"] = "忽略死者"
...
L["Malformed M33Auras link"] = "格式錯誤的 M33Auras 連結"
L["Manual"] = "手動"
L["Manual Icon"] = "手動圖示"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "檢測到安全框架。查詢更多訊息：https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the M33Auras Discord server for help."] = "這個過濾方式已經移動到位置觸發器。請更改您的提醒效果以使用新的位置觸發器，或加入 M33Auras Discord 伺服器尋求幫助。"
...
L["True"] = "是 (True)"
L["Trying to repair broken conditions in %s likely caused by a M33Auras bug."] = "嘗試修復 %s 中可能是由 M33Auras 的 bug 引起的損壞狀況。"
L["Twin Emperors"] = "雙子皇帝"
L["Type"] = "類型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to m33shoq."] = "無法更新提醒效果 ‘%s’。可能是由於資料損壞或不良遷移所致，請向 M33Auras 團隊報告此問題。"
L["Unaffected"] = "未受影響"
L["Undefined"] = "未定義"
L["Unholy"] = "穢邪"
...
L["Using M33Auras.clones is deprecated. Use M33Auras.GetRegion(id, cloneId) instead."] = "M33Auras.clones 已經被移除，請改用 M33Auras.GetRegion(id, cloneId)。"
L["Using M33Auras.regions is deprecated. Use M33Auras.GetRegion(id) instead."] = "M33Auras.regions 已經被移除，請改用 M33Auras.GetRegion(id)。"
...
L["M33Auras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "M33Auras 內建的 (63:42 | 3:07 | 10 | 2.4)"
L["M33Auras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/M33Auras."] = "M33Auras 偵測到空設定。如果發生意外情況，請在 https://discord.gg/M33Auras 上尋求協助。"
L[ [=[M33Auras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[M33Auras 偵測到它被降回舊版本，你所儲存的提醒效果已無法正常運作。
是否要執行|cffff0000實驗性的|r修復工具? 將會覆蓋自上次資料庫升級以來所做的任何更改。
上次升級是: %s

|cffff0000在按下此按鈕之前，你應該先備份 WTF 資料夾。|r]=]
L["M33Auras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "M33Auras 正在建立提醒效果的還原快照。如果出現問題，此快照將允許您恢復到提醒效果目前的狀態。此過程可能會導致幀速下降，直到完成為止。"
L["M33Auras Profiling"] = "M33Auras 效能分析"
L["M33Auras Profiling Report"] = "M33Auras 分析報告"
L["M33Auras Version: %s"] = "M33Auras 版本: %s"
L["Weapon"] = "武器"
...
L["Writing to the M33Auras table is not allowed."] = "不允許寫入 M33Auras table。"
L["X-Offset"] = "水平位移"
L["Yell"] = "大喊"
L["Y-Offset"] = "垂直位移"

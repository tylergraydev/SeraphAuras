...
https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000El soporte para COMBAT_LOG_EVENT_UNFILTERED sin filtro está obsoleto|r COMBAT_LOG_EVENT_UNFILTERED sin un filtro están deshabilitados ya que son muy costosos en términos de rendimiento. Más información: https://github.com/m33shoq/M33Auras/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "Una descripción detallada de tus sistemas de auras y M33Auras. Copia todo el texto en el Discord de WeakAura si necesitas ayuda."
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "No se puede cambiar el marco de seguridad en el bloqueo de combate. Más información: https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
...
L["Copper"] = "Cobre"
L["Could not load M33Auras Archive, the addon is %s"] = "No se pudo cargar M33Auras Archive, el addon está %s"
L["Count"] = "Recuento"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "El error '%s' ha creado un clon seguro. Aconsejamos eliminar el aura. Para más información: https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
L["Error decoding."] = "Error al descodificar."
L["Error decompressing"] = "Error al descomprimir"
L["Error decompressing. This doesn't look like a M33Auras import."] = "Error al descomprimir. Esto no parece una importación de M33Auras."
...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/M33Auras!"] = "Si necesitas más ayuda, abre un ticket en GitHub o visita nuestro Discord en https://discord.gg/M33Auras."
...
L["Malformed M33Auras link"] = "Enlace M33Auras malformado"
L["Manual"] = "Manual"
...
https://github.com/m33shoq/M33Auras/wiki/Protected-Frames]=] ] = "Marco seguro detectado. Encuentra más información: https://github.com/m33shoq/M33Auras/wiki/Protected-Frames"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the M33Auras Discord server for help."] = "Este filtro ha sido trasladado al disparador de ubicación. Cambia tu aura para utilizar el nuevo disparador de ubicación o únete al servidor de Discord de M33Auras para obtener ayuda."
...
L["True"] = "Verdadero"
L["Trying to repair broken conditions in %s likely caused by a M33Auras bug."] = "Intentando reparar condiciones rotas en %s probablemente causadas por un error de M33Auras."
L["Twin Emperors"] = "Emperadores gemelos"
L["Type"] = "Tipo"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to m33shoq."] = "No se puede modernizar el aura '%s'. Probablemente se deba a datos corruptos o una migración incorrecta. Por favor, informe de esto al equipo de M33Auras."
...
L["Using M33Auras.clones is deprecated. Use M33Auras.GetRegion(id, cloneId) instead."] = [=[El uso de M33Auras.clones está en desuso. Utilice M33Auras.GetRegion(id, cloneId) en su lugar.
]=]
L["Using M33Auras.regions is deprecated. Use M33Auras.GetRegion(id) instead."] = "El uso de M33Auras.regions está en desuso. Utilice M33Auras.GetRegion(id) en su lugar."
...
​]=]
L["M33Auras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "M33Auras incorporado (63:42 | 3:07 | 10 | 2.4)"
L["M33Auras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/M33Auras."] = "M33Auras ha detectado configuraciones vacías. Si esto es inesperado, solicita asistencia en https://discord.gg/M33Auras."
L[ [=[M33Auras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = "M33Auras ha detectado que ha sido degradado. Es posible que tus auras guardadas ya no funcionen correctamente. ¿Te gustarías ejecutar la herramienta de reparación |cffff0000EXPERIMENTAL|r? Esto sobrescribirá cualquier cambio que haya realizado desde la última actualización de la base de datos. Última actualización: %s |cffff0000Debes HACER UNA COPIA DE SEGURIDAD de tu carpeta WTF ANTES de presionar este botón.|r"
L["M33Auras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "M33Auras está creando una instantánea de reversión de tus auras. Esta instantánea te permitirá volver al estado actual de tus auras si algo sale mal. Este proceso puede hacer que tu tasa de fotogramas disminuya hasta que se complete."
L["M33Auras Profiling"] = "Perfilado de M33Auras"
L["M33Auras Profiling Report"] = "Informe de perfilado de M33Auras"
L["M33Auras Version: %s"] = "M33Auras Versión: %s"
L["Weapon"] = "Arma"
...
L["Writing to the M33Auras table is not allowed."] = "No se permite escribir en la tabla M33Auras."

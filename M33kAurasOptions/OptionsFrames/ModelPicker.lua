...
local function ConstructModelPicker(frame)
  ...
  local filterInput = CreateFrame("EditBox", "M33kAurasFilterInput", group.frame, "SearchBoxTemplate")
  ...
  local modelTree = AceGUI:Create("M33kAurasTreeGroup");
  ...
  modelTree:SetTree(M33kAuras.ModelPaths);
  ...
  function group.PickSt(self, model_fileId, model_tx, model_ty, model_tz, model_rx, model_ry, model_rz, model_us)
    ...
    M33kAuras.SetModel(self.model, nil, self.selectedValues.model_fileId)

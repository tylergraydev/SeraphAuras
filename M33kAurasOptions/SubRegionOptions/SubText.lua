...
local function createOptions(parentData, data, index, subIndex)
  ...
  local options = {
    ...
    text_text = {
      ...
      control = "M33kAurasInputWithIndentation",
      callbacks = {
    ...
    text_fontType = {
      type = "select",
      width = M33kAuras.normalWidth - indentWidth,
      name = L["Outline"],
      order = 46,
  ...
  OptionsPrivate.commonOptions.AddCodeOption(commonTextOptions, parentData, L["Custom Function"], "customText",
                          "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#custom-text",
  ...
  local function addOption(key, option)
    ...
    if option.reloadOptions then
      ...
      option.set = function(info, v)
        ...
        M33kAuras.Add(parentData)
        M33kAuras.ClearAndUpdateOptions(parentData.id, true)
      end
    end
...
M33kAuras.RegisterSubRegionOptions("subtext", createOptions,

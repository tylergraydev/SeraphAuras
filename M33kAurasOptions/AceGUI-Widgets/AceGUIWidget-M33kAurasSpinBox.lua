...
Spin Box Widget
-------------------------------------------------------------------------------]]
local Type, Version = "M33kAurasSpinBox", 5
...
local progressLeftOffset = M33kAuras.IsClassicOrWrathOrCata() and -2 or -3
local progressExtraWidth = M33kAuras.IsClassicOrWrathOrCata() and -2 or 0
local progressTopOffset = M33kAuras.IsClassicOrWrathOrCata() and -3 or -2
local progressBottomOffset = M33kAuras.IsClassicOrWrathOrCata() and 3 or 2
...
local function Constructor()
  ...
  leftbutton:SetSize(16, 16)
	leftbutton:SetNormalTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxleft")
  leftbutton:SetHighlightTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxlefth")
	leftbutton:SetPushedTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxleftp")
	leftbutton:SetDisabledTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxleftp")
  leftbutton:SetScript("OnClick", SpinBox_OnValueDown)

  local rightbutton = CreateFrame("Button", nil, frame)
  rightbutton:SetSize(16, 16)
	rightbutton:SetNormalTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxright")
  rightbutton:SetHighlightTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxrighth")
	rightbutton:SetPushedTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxrightp")
	rightbutton:SetDisabledTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxrightp")
  ...
  progressBar:SetTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\spinboxoverlay")
  ...
  progressBarHandleTexture:SetTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\Square_White")

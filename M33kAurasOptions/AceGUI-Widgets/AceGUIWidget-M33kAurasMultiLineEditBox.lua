...
local Type, Version = "M33kAurasMultiLineEditBox", 39
...
if not AceGUIM33kAurasMultiLineEditBoxInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIM33kAurasMultiLineEditBoxInsertLink(...) end)
end

function _G.AceGUIM33kAurasMultiLineEditBoxInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("M33kAurasMultiLineEditBox%uEdit"):format(i)]
...
local function Constructor()
  ...
  local scrollBG = CreateFrame("Frame", nil, frame, "BackdropTemplateM33kAuras")

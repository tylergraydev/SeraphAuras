...
-------------------------------------------------------------------------------]]
local Type, Version = "M33kAurasProgressBar", 2
...
local function Constructor()
  ...
  foreground:SetTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\Square_White")
  background:SetTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\Square_White")

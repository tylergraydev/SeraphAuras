...
local Type, Version = "M33kAuras-MultiLineEditBoxWithEnter", 2
...
if not AceGUIM33kAurasMultiLineEditBoxWithEnterInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIM33kAurasMultiLineEditBoxWithEnterInsertLink(...) end)
end

function _G.AceGUIM33kAurasMultiLineEditBoxWithEnterInsertLink(text)

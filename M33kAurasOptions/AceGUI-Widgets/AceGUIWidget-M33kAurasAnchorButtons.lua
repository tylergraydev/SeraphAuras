...
local Type, Version = "M33kAurasAnchorButtons", 2
...
local function Constructor()
  local name = "M33kAurasAnchorButtons" .. AceGUI:GetNextWidgetNum(Type)
  ...
  local background = CreateFrame("Frame", nil, frame, "BackdropTemplateM33kAuras")
  background:SetSize(frameWidth, frameHeight)
  background:SetPoint("TOP", frame, "TOP", 0, -(titleHeight + 4))
  background:SetBackdrop({
     bgFile = "Interface\\AddOns\\M33kAuras\\Media\\Textures\\Square_FullWhite.tga",
     edgeFile = "Interface\\AddOns\\M33kAuras\\Media\\Textures\\Square_FullWhite.tga",
     tile = true,
     tileEdge = true,
     --tileSize = 8,
     edgeSize = 2
  ...
  for _, direction in ipairs(directions) do
    ...
    buttonTex:SetTexture("Interface\\AddOns\\M33kAuras\\Media\\Textures\\Square_FullWhite.tga")

...
local Type, Version = "M33kAurasTextureButton", 26
...
local function Constructor()
  local name = "M33kAurasTextureButton"..AceGUI:GetNextWidgetNum(Type);
  local button = CreateFrame("Button", name, UIParent, "OptionsListButtonTemplate");
  if BackdropTemplateM33kAurasMixin then
    Mixin(button, BackdropTemplateM33kAurasMixin)
  end

...
local function Constructor()
	...
	local treeframeBG = CreateFrame("Frame", nil, treeframe, "BackdropTemplateM33kAuras")
	...
	local dragger = CreateFrame("Frame", nil, treeframe, "BackdropTemplateM33kAuras")
	dragger:SetWidth(8)
	...
	local border = CreateFrame("Frame", nil, frame, "BackdropTemplateM33kAuras")

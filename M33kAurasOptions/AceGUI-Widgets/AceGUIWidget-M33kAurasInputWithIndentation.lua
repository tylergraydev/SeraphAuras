...
local Type, Version = "M33kAurasInputWithIndentation", 2
...
if not AceGUIM33kAurasInputWithIndentationInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIM33kAurasInputWithIndentationInsertLink(...) end)
end

function _G.AceGUIM33kAurasInputWithIndentationInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("M33kAurasInputWithIndentation%uEdit"):format(i)]
...
local function Constructor()
  ...
  local editbox = CreateFrame("EditBox", string.format("M33kAurasInputWithIndentation%uEdit", format(num)), frame, "InputBoxTemplate")

...
local widgetType, widgetVersion = "M33kAurasMiniTalent", 3
...
local function Constructor()
  ...
  -- rescale buttons and resize frame to fit in M33kAuras options
  ...
  local toggle = AceGUI:Create("M33kAurasToolbarButton")

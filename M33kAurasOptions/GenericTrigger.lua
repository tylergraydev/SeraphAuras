...
local function GetCustomTriggerOptions(data, triggernum)
  ...
  local customOptions =
  {
    ...
    events = {
      type = "input",
      multiline = true,
      control = "M33kAuras-MultiLineEditBoxWithEnter",
    ...
    event_customError = {
      ...
      name = function()
        ...
        -- Check for errors
        for _, event in pairs(M33kAuras.split(events)) do
          local trueEvent
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Custom Trigger"], "custom_trigger", "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#custom-trigger",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Custom Variables"], "custom_variables", "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#custom-variables",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Custom Untrigger"], "custom_untrigger", "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#custom-untrigger",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Duration Info"], "custom_duration", "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#duration-info",
  ...
  for i = 1, 7 do
    ...
    OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, string.format(L["Overlay %s Info"], i), "custom_overlay" .. i, "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#overlay-info",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Name Info"], "custom_name",
                          "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#name-info",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Icon Info"], "custom_icon",
                          "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#icon-info",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Texture Info"], "custom_texture",
                          "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#texture-info",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(customOptions, data, L["Stack Info"], "custom_stacks",
                          "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#stack-info",
...
local function GetGenericTriggerOptions(data, triggernum)
  ...
  local combatLogCategory = M33kAuras.GetTriggerCategoryFor("Combat Log")
...
M33kAuras.RegisterTriggerSystemOptions(M33kAuras.genericTriggerTypes, GetGenericTriggerOptions);

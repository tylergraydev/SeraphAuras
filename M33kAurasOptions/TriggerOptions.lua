...
local function GetGlobalOptions(data)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(globalTriggerOptions, data, L["Custom"], "custom_trigger_combination", "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#custom-activation",
...
function OptionsPrivate.AddTriggerMetaFunctions(options, data, triggernum)
  ...
  options.__delete = {
    ...
    func = function(...)
      ...
      if canDelete then
        StaticPopupDialogs["M33kAuras_CONFIRM_TRIGGER_DELETE"] = {
        ...
        StaticPopup_Show("M33kAuras_CONFIRM_TRIGGER_DELETE")
      end
    end
  }

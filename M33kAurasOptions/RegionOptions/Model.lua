...
local function createOptions(id, data)
  local options = {
    ...
    modelIsUnit = {
      ...
      order = 0.5,
      hidden = function() return data.modelDisplayInfo and M33kAuras.BuildInfo > 80100 end
    },
    modelDisplayInfo = {
      type = "toggle",
      width = M33kAuras.normalWidth,
    ...
    chooseModel = {
      ...
      disabled = function() return data.modelIsUnit or (M33kAuras.BuildInfo > 80100 and data.modelDisplayInfo) end,
      imageWidth = 24,
      imageHeight = 24,
...
local function modifyThumbnail(parent, region, data)
  ...
  M33kAuras.SetModel(model, nil, data.model_fileId, data.modelIsUnit, data.modelDisplayInfo)

...
local function createOptions(id, data)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(options, data, L["Custom Function"], "customText", "https://github.com/m33shoq/M33kAuras/wiki/Custom-Code-Blocks#custom-text",

...
local function GetGlobalOptions(data)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(globalTriggerOptions, data, L["Custom"], "custom_trigger_combination", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#custom-activation",
...
function OptionsPrivate.AddTriggerMetaFunctions(options, data, triggernum)
  ...
  options.__delete = {
    ...
    func = function(...)
      ...
      if canDelete then
        StaticPopupDialogs["M33Auras_CONFIRM_TRIGGER_DELETE"] = {
        ...
        StaticPopup_Show("M33Auras_CONFIRM_TRIGGER_DELETE")
      end
    end
  }

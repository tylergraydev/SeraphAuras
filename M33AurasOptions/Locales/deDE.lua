...
Enable this setting if you want this timer to be hidden, or when using a M33Auras text to display the timer]=] ] = [=[A timer will automatically be displayed according to default Interface Settings (overridden by some addons).
Enable this setting if you want this timer to be hidden, or when using a M33Auras text to display the timer]=]
	--[[Translation missing --]]
...
Off Screen]=]
	...
	--[[Translation missing --]]
	L["Chat with M33Auras experts on our Discord server."] = "Chat with M33Auras experts on our Discord server."
...
Da es sich um einen Zustands-Auslöser handelt, kann es passieren, dass M33Auras nicht die in der WoW-API spezifizierten Argumente übergibt.
...
every 3 events starting from 2nd and ending at 11th: 2-11/3]=]
	...
	--[[Translation missing --]]
	L["Requires LibSpecialization, that is e.g. a up-to date M33Auras version"] = "Requires LibSpecialization, that is e.g. a up-to date M33Auras version"
	--[[Translation missing --]]
	...
	--[[Translation missing --]]
	L["The M33Auras Options Addon version %s doesn't match the M33Auras version %s. If you updated the addon while the game was running, try restarting World of Warcraft. Otherwise try reinstalling M33Auras"] = "The M33Auras Options Addon version %s doesn't match the M33Auras version %s. If you updated the addon while the game was running, try restarting World of Warcraft. Otherwise try reinstalling M33Auras"
	L["Then "] = "Dann"
	--[[Translation missing --]]
...
It might not work correctly!]=]
	--[[Translation missing --]]
	L[ [=[This aura was created with a newer version of M33Auras.
Upgrade your version of M33Auras or wait for next release before installing this aura.]=] ] = [=[This aura was created with a newer version of M33Auras.
Upgrade your version of M33Auras or wait for next release before installing this aura.]=]
	...
	L["We thank"] = "We thank"
	--[[Translation missing --]]
	L["M33Auras %s on WoW %s"] = "M33Auras %s on WoW %s"
	--[[Translation missing --]]
	L["M33Auras recommends using spell ids instead of names. Spell ids are automatically localized."] = "M33Auras recommends using spell ids instead of names. Spell ids are automatically localized."
	--[[Translation missing --]]
...
Would you like to continue?]=]
	--[[Translation missing --]]
	L[ [=[You can add a comma-separated list of state values here that (when changed) M33Auras should also run the Anchor Code on.

M33Auras will always run custom anchor code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=] ] = [=[You can add a comma-separated list of state values here that (when changed) M33Auras should also run the Anchor Code on.

M33Auras will always run custom anchor code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=]
	--[[Translation missing --]]
	L[ [=[You can add a comma-separated list of state values here that (when changed) M33Auras should also run the Grow Code on.

M33Auras will always run custom grow code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=] ] = [=[You can add a comma-separated list of state values here that (when changed) M33Auras should also run the Grow Code on.

M33Auras will always run custom grow code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=]
	--[[Translation missing --]]
	L["You can add a comma-separated list of state values here that (when changed) M33Auras should also run the sort code on.M33Auras will always run custom sort code if you include 'changed' in this list, or when a region is added, removed."] = "You can add a comma-separated list of state values here that (when changed) M33Auras should also run the sort code on.M33Auras will always run custom sort code if you include 'changed' in this list, or when a region is added, removed."
	--[[Translation missing --]]

...
local function ConstructModelPicker(frame)
  ...
  local filterInput = CreateFrame("EditBox", "M33AurasFilterInput", group.frame, "SearchBoxTemplate")
  ...
  local modelTree = AceGUI:Create("M33AurasTreeGroup");
  ...
  modelTree:SetTree(M33Auras.ModelPaths);
  ...
  function group.PickSt(self, model_fileId, model_tx, model_ty, model_tz, model_rx, model_ry, model_rz, model_us)
    ...
    M33Auras.SetModel(self.model, nil, self.selectedValues.model_fileId)

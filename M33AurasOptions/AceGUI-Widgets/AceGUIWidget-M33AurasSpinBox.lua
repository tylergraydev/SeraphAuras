...
Spin Box Widget
-------------------------------------------------------------------------------]]
local Type, Version = "M33AurasSpinBox", 5
...
local progressLeftOffset = M33Auras.IsClassicOrWrathOrCata() and -2 or -3
local progressExtraWidth = M33Auras.IsClassicOrWrathOrCata() and -2 or 0
local progressTopOffset = M33Auras.IsClassicOrWrathOrCata() and -3 or -2
local progressBottomOffset = M33Auras.IsClassicOrWrathOrCata() and 3 or 2
...
local function Constructor()
  ...
  leftbutton:SetSize(16, 16)
	leftbutton:SetNormalTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxleft")
  leftbutton:SetHighlightTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxlefth")
	leftbutton:SetPushedTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxleftp")
	leftbutton:SetDisabledTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxleftp")
  leftbutton:SetScript("OnClick", SpinBox_OnValueDown)

  local rightbutton = CreateFrame("Button", nil, frame)
  rightbutton:SetSize(16, 16)
	rightbutton:SetNormalTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxright")
  rightbutton:SetHighlightTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxrighth")
	rightbutton:SetPushedTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxrightp")
	rightbutton:SetDisabledTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxrightp")
  ...
  progressBar:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\spinboxoverlay")
  ...
  progressBarHandleTexture:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_White")

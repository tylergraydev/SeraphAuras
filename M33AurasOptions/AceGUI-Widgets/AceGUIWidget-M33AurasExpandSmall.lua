...
local Type, Version = "M33AurasExpandSmall", 4
...
local methods = {
  ...
  ["SetImage"] = function(self, path, ...)
    ...
    if path == "collapsed" then
      ...
      path = "Interface\\AddOns\\M33Auras\\Media\\Textures\\gear"
    elseif path == "expanded" then
      self:SetExpandedState(true)
      path = "Interface\\AddOns\\M33Auras\\Media\\Textures\\geardown"
    else
      self:SetExpandedState(false)
    end
...
local function Constructor()
  ...
  highlight:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_White")
  ...
  expandedHighlight:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_White")
  ...
  expandedBackground:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_AlphaGradient")

...
local Type, Version = "M33AurasAnchorButtons", 2
...
local function Constructor()
  local name = "M33AurasAnchorButtons" .. AceGUI:GetNextWidgetNum(Type)
  ...
  local background = CreateFrame("Frame", nil, frame, "BackdropTemplateM33Auras")
  background:SetSize(frameWidth, frameHeight)
  background:SetPoint("TOP", frame, "TOP", 0, -(titleHeight + 4))
  background:SetBackdrop({
     bgFile = "Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_FullWhite.tga",
     edgeFile = "Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_FullWhite.tga",
     tile = true,
     tileEdge = true,
     --tileSize = 8,
     edgeSize = 2
  ...
  for _, direction in ipairs(directions) do
    ...
    buttonTex:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_FullWhite.tga")

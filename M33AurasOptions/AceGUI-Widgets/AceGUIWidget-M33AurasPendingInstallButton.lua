...
local Type, Version = "M33AurasPendingInstallButton", 3
...
local methods = {
  ...
  ["Initialize"] = function(self, id, companionData)
    ...
    function self.callbacks.OnUpdateClick()
      M33Auras.Import(self.companionData.encoded)
    end
...
local function Constructor()
  local name = "M33AurasPendingInstallButton" .. AceGUI:GetNextWidgetNum(Type)

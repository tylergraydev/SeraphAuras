...
local Type, Version = "M33Auras-MultiLineEditBoxWithEnter", 2
...
if not AceGUIM33AurasMultiLineEditBoxWithEnterInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIM33AurasMultiLineEditBoxWithEnterInsertLink(...) end)
end

function _G.AceGUIM33AurasMultiLineEditBoxWithEnterInsertLink(text)

...
-------------------------------------------------------------------------------]]
local Type, Version = "M33AurasProgressBar", 2
...
local function Constructor()
  ...
  foreground:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_White")
  background:SetTexture("Interface\\AddOns\\M33Auras\\Media\\Textures\\Square_White")

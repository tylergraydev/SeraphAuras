...
local Type, Version = "M33AurasTextureButton", 26
...
local function Constructor()
  local name = "M33AurasTextureButton"..AceGUI:GetNextWidgetNum(Type);
  local button = CreateFrame("Button", name, UIParent, "OptionsListButtonTemplate");
  if BackdropTemplateM33AurasMixin then
    Mixin(button, BackdropTemplateM33AurasMixin)
  end

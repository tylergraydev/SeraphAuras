...
local Type, Version = "M33AurasInputWithIndentation", 2
...
if not AceGUIM33AurasInputWithIndentationInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIM33AurasInputWithIndentationInsertLink(...) end)
end

function _G.AceGUIM33AurasInputWithIndentationInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("M33AurasInputWithIndentation%uEdit"):format(i)]
...
local function Constructor()
  ...
  local editbox = CreateFrame("EditBox", string.format("M33AurasInputWithIndentation%uEdit", format(num)), frame, "InputBoxTemplate")

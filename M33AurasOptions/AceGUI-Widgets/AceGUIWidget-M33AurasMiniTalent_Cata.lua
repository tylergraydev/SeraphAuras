...
local widgetType, widgetVersion = "M33AurasMiniTalent", 3
...
local function Constructor()
  ...
  -- rescale buttons and resize frame to fit in M33Auras options
  ...
  local toggle = AceGUI:Create("M33AurasToolbarButton")

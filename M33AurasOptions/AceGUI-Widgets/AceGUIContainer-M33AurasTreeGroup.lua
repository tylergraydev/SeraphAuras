...
local function Constructor()
	...
	local treeframeBG = CreateFrame("Frame", nil, treeframe, "BackdropTemplateM33Auras")
	...
	local dragger = CreateFrame("Frame", nil, treeframe, "BackdropTemplateM33Auras")
	dragger:SetWidth(8)
	...
	local border = CreateFrame("Frame", nil, frame, "BackdropTemplateM33Auras")

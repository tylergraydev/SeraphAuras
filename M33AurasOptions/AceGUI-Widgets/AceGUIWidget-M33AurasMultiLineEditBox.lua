...
local Type, Version = "M33AurasMultiLineEditBox", 39
...
if not AceGUIM33AurasMultiLineEditBoxInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIM33AurasMultiLineEditBoxInsertLink(...) end)
end

function _G.AceGUIM33AurasMultiLineEditBoxInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("M33AurasMultiLineEditBox%uEdit"):format(i)]
...
local function Constructor()
  ...
  local scrollBG = CreateFrame("Frame", nil, frame, "BackdropTemplateM33Auras")

...
function OptionsPrivate.GetActionOptions(data)
    ...
    args = {
      ...
      start_choose_glow_frame = {
        ...
        func = function()
          if(data.controlledChildren and data.controlledChildren[1]) then
            M33Auras.PickDisplay(data.controlledChildren[1]);
            OptionsPrivate.StartFrameChooser(M33Auras.GetData(data.controlledChildren[1]), {"actions", "start", "glow_frame"});
          else
      ...
      finish_choose_glow_frame = {
        ...
        func = function()
          if(data.controlledChildren and data.controlledChildren[1]) then
            M33Auras.PickDisplay(data.controlledChildren[1]);
            OptionsPrivate.StartFrameChooser(M33Auras.GetData(data.controlledChildren[1]), {"actions", "finish", "glow_frame"});
          else
  ...
  OptionsPrivate.commonOptions.AddCodeOption(action.args, data, L["Custom Code"], "init", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#on-init",
                          0.21, function() return not data.actions.init.do_custom end, {"actions", "init", "custom"}, true)

  OptionsPrivate.commonOptions.AddCodeOption(action.args, data, L["Custom Code"], "customOnLoad", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#on-load",
                          0.31, function() return not data.actions.init.do_custom_load end, {"actions", "init", "customOnLoad"}, true)
  OptionsPrivate.commonOptions.AddCodeOption(action.args, data, L["Custom Code"], "customOnUnload", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#on-unload",
                          0.41, function() return not data.actions.init.do_custom_unload end, {"actions", "init", "customOnUnload"}, true)

  OptionsPrivate.commonOptions.AddCodeOption(action.args, data, L["Custom Code"], "start_message", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#chat-message---custom-code",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(action.args, data, L["Custom Code"], "start", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#on-show",
                          13, function() return not data.actions.start.do_custom end, {"actions", "start", "custom"}, true);

  OptionsPrivate.commonOptions.AddCodeOption(action.args, data, L["Custom Code"], "finish_message", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#chat-message---custom-code",
  ...
  OptionsPrivate.commonOptions.AddCodeOption(action.args, data, L["Custom Code"], "finish", "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#on-hide",

...
local L = M33Auras.L;
local GetAtlasInfo = M33Auras.IsClassicEra() and GetAtlasInfo or C_Texture.GetAtlasInfo
...
local function createIcon()
  local data = {
    foregroundTexture = "Interface\\Addons\\M33Auras\\PowerAurasMedia\\Auras\\Aura3",
    backgroundTexture = "Interface\\Addons\\M33Auras\\PowerAurasMedia\\Auras\\Aura3",
    sameTexture = true,
    backgroundOffset = 2,
    blendMode = "BLEND",
    width = 200,

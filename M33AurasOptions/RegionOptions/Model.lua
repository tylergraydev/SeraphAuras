...
local function createOptions(id, data)
  local options = {
    ...
    modelIsUnit = {
      ...
      order = 0.5,
      hidden = function() return data.modelDisplayInfo and M33Auras.BuildInfo > 80100 end
    },
    modelDisplayInfo = {
      type = "toggle",
      width = M33Auras.normalWidth,
    ...
    chooseModel = {
      ...
      disabled = function() return data.modelIsUnit or (M33Auras.BuildInfo > 80100 and data.modelDisplayInfo) end,
      imageWidth = 24,
      imageHeight = 24,

...
local function createOptions(parentData, data, index, subIndex)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(commonTextOptions, parentData, L["Custom Function"], "customText",
                          "https://github.com/m33shoq/M33Auras/wiki/Custom-Code-Blocks#custom-text",
  ...
  local function addOption(key, option)
    ...
    if option.reloadOptions then
      ...
      option.set = function(info, v)
        ...
        M33Auras.Add(parentData)
        M33Auras.ClearAndUpdateOptions(parentData.id, true)
      end
    end
...
M33Auras.RegisterSubRegionOptions("subtext", createOptions,

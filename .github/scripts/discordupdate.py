...
MSG = """React to this message to have your name included in the Thanks list inside the M33kAuras GUI.
...
class DiscordNameGather(discord.Client):
  ...
  def writeFile(self):
    ...
    discordListFile = open("M33kAuras/DiscordList.lua", "w", encoding="utf-8")
    discordListFile.write("if not M33kAuras.IsLibsOK() then return end\n")

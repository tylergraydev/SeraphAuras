...
local classIDToOffsets = {
	[1] = { extraOffsetX = M33kAuras.IsTWW() and 60 or 30, extraOffsetY = 31, }, -- Warrior
...
for k, v in pairs(texture_data) do
	...
	if atlasInfo then
		...
		M33kAuras.StopMotion.texture_data[k] = v
		M33kAuras.StopMotion.texture_types.Blizzard[k] = k
	end
end

...
https://github.com/m33shoq/M33kAuras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트의 지원은 중단됐습니다|r 필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트는 성능 소모가 심해 사용할 수 없습니다. 자세한 정보: https://github.com/m33shoq/M33kAuras/wiki/Custom-Triggers#events"
...
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=] ] = [=[전투 중에는 보안 프레임을 변경할 수 없습니다. 자세한 정보:
...
L["Copper"] = "코퍼"
L["Could not load M33kAuras Archive, the addon is %s"] = "M33kAuras Archive를 불러올 수 없습니다. 애드온이 %s 상태입니다"
L["Count"] = "개수"
...
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=] ] = [=['%s' 오류가 보안 요소의 복사본을 생성했습니다. 이 위크오라는 삭제할 것을 권장합니다. 자세한 정보:
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=]
L["Error decoding."] = "디코딩 오류입니다."
L["Error decompressing"] = "압축 해제 오류"
L["Error decompressing. This doesn't look like a M33kAuras import."] = "압축을 푸는 중 오류가 발생했습니다. M33kAuras 가져오기 문자열이 아닙니다."
...
L["Malformed M33kAuras link"] = "잘못된 M33kAuras 링크"
L["Manual"] = "수동 설정"
...
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=] ] = [=[보안 프레임이 감지됐습니다. 자세한 정보:
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=]
...
L["True"] = "참"
L["Trying to repair broken conditions in %s likely caused by a M33kAuras bug."] = "%s에서 M33kAuras 버그로 인해 망가진 조건 복구를 시도중입니다."
L["Twin Emperors"] = "쌍둥이 제왕"
L["Type"] = "종류"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to m33shoq."] = "'%s' 위크오라를 현대화할 수 없습니다. 데이터 오염이나 마이그레이션에 문제가 있는 것 같습니다. 이 내역을 M33kAuras 팀에 제보해 주세요."
...
L["Using M33kAuras.clones is deprecated. Use M33kAuras.GetRegion(id, cloneId) instead."] = "M33kAuras.clones는 더이상 사용할 수 없습니다. M33kAuras.GetRegion(id, cloneId)를 사용하세요."
L["Using M33kAuras.regions is deprecated. Use M33kAuras.GetRegion(id) instead."] = "M33kAuras.regions는 더이상 사용할 수 없습니다. M33kAuras.GetRegion(id)를 사용하세요."
...
|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[M33kAuras가 다운그레이드를 감지했습니다.
...
L["M33kAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "M33kAuras가 보유한 위크오라의 롤백 스냅샷을 생성중입니다. 위크오라에 문제가 발생할 경우 이 스냅샷을 통해 현재 상태의 위크오라로 복원할 수 있습니다. 작업이 완료될 때까지 프레임드랍이 발생할 수 있습니다."
L["M33kAuras Profiling"] = "M33kAuras 성능 분석"
L["M33kAuras Profiling Report"] = "M33kAuras 성능 분석 보고서"
L["M33kAuras Version: %s"] = "M33kAuras 버전: %s"
L["Weapon"] = "무기"
...
L["Writing to the M33kAuras table is not allowed."] = "M33kAuras 테이블에 작성하는 행위는 허용되지 않습니다."
L["X-Offset"] = "X-위치 조정"
L["Yell"] = "외침"
L["Y-Offset"] = "Y-위치 조정"

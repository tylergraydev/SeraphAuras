...
https://github.com/m33shoq/M33kAuras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000已經不再支援未過濾的 COMBAT_LOG_EVENT_UNFILTERED|r 因為非常耗效能，已停用沒有過濾程式的 COMBAT_LOG_EVENT_UNFILTERED。更多資訊請看: https://github.com/m33shoq/M33kAuras/wiki/Custom-Triggers#events"
...
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=] ] = "無法在戰鬥鎖定中更改安全框架。查詢更多資訊：https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames"
...
L["Copper"] = "銅"
L["Could not load M33kAuras Archive, the addon is %s"] = "無法載入M33kAuras Archive，此插件為 %s"
L["Count"] = "數量"
...
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=] ] = "錯誤 '%s' 創建了一個安全複製品。我們建議刪除光環。更多訊息：https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames"
L["Error decoding."] = "解碼時出錯。"
L["Error decompressing"] = "解壓縮時出錯"
L["Error decompressing. This doesn't look like a M33kAuras import."] = "解壓縮時出錯，這看起來不像是 M33kAuras 的匯入字串。"
...
L["Malformed M33kAuras link"] = "格式錯誤的 M33kAuras 連結"
L["Manual"] = "手動"
L["Manual Icon"] = "手動圖示"
...
https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames]=] ] = "檢測到安全框架。查詢更多訊息：https://github.com/m33shoq/M33kAuras/wiki/Protected-Frames"
...
L["True"] = "是 (True)"
L["Trying to repair broken conditions in %s likely caused by a M33kAuras bug."] = "嘗試修復 %s 中可能是由 M33kAuras 的 bug 引起的損壞狀況。"
L["Twin Emperors"] = "雙子皇帝"
L["Type"] = "類型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to m33shoq."] = "無法更新提醒效果 ‘%s’。可能是由於資料損壞或不良遷移所致，請向 M33kAuras 團隊報告此問題。"
L["Unaffected"] = "未受影響"
L["Undefined"] = "未定義"
L["Unholy"] = "穢邪"
...
L["Using M33kAuras.clones is deprecated. Use M33kAuras.GetRegion(id, cloneId) instead."] = "M33kAuras.clones 已經被移除，請改用 M33kAuras.GetRegion(id, cloneId)。"
L["Using M33kAuras.regions is deprecated. Use M33kAuras.GetRegion(id) instead."] = "M33kAuras.regions 已經被移除，請改用 M33kAuras.GetRegion(id)。"
...
|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[M33kAuras 偵測到它被降回舊版本，你所儲存的提醒效果已無法正常運作。
是否要執行|cffff0000實驗性的|r修復工具? 將會覆蓋自上次資料庫升級以來所做的任何更改。
上次升級是: %s

|cffff0000在按下此按鈕之前，你應該先備份 WTF 資料夾。|r]=]
L["M33kAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "M33kAuras 正在建立提醒效果的還原快照。如果出現問題，此快照將允許您恢復到提醒效果目前的狀態。此過程可能會導致幀速下降，直到完成為止。"
L["M33kAuras Profiling"] = "M33kAuras 效能分析"
L["M33kAuras Profiling Report"] = "M33kAuras 分析報告"
...
L["Writing to the M33kAuras table is not allowed."] = "不允許寫入 M33kAuras table。"
L["X-Offset"] = "水平位移"
L["Yell"] = "大喊"
L["Y-Offset"] = "垂直位移"

...
local default = function(parentType)
  local defaults = {
    ...
    textureTexture = "Interface\\Addons\\M33kAuras\\PowerAurasMedia\\Auras\\Aura3",
...
M33kAuras.RegisterSubRegionType("subtexture", L["Texture"], supports, create, modify, onAcquire, onRelease, default, nil, properties)

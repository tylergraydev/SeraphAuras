...
local default = function(parentType)
  local defaults = {
    ...
    circularTextureTexture = "Interface\\AddOns\\M33kAuras\\Media\\Textures\\square_border_5px.tga",
...
M33kAuras.RegisterSubRegionType("subcirculartexture", L["Circular Texture"], supports, create, modify, onAcquire, onRelease,

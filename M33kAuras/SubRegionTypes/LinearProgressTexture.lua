...
local default = function(parentType)
  local defaults = {
    ...
    linearTextureTexture = "Interface\\AddOns\\M33kAuras\\Media\\Textures\\Square_FullWhite",
...
M33kAuras.RegisterSubRegionType("sublineartexture", L["Linear Texture"], supports, create, modify, onAcquire, onRelease,

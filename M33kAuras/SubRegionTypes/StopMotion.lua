...
local default = function(parentType)
  local defaults = {
    ...
    stopmotionTexture = "Interface\\AddOns\\M33kAuras\\Media\\Textures\\stopmotion",
  ...
  if C_AddOns.IsAddOnLoaded("M33kAurasStopMotion") then
    defaults.stopmotionTexture = "Interface\\AddOns\\M33kAurasStopMotion\\Textures\\IconOverlays\\ArcReactor"
...
M33kAuras.RegisterSubRegionType("substopmotion", L["Stop Motion"], supports, create, modify, onAcquire, onRelease, default, nil, properties)

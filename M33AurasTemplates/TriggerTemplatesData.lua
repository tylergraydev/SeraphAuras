...
if not M33Auras.IsRetail() then return end
local L = M33Auras.L
...
-- Collected by M33AurasTemplateCollector:
--------------------------------------------------------------------------------
...
tinsert(templates.general.args, {
  ...
  icon = "Interface\\Addons\\M33Auras\\PowerAurasMedia\\Auras\\Aura78",
  triggers = {[1] = { trigger = {
    type = M33Auras.GetTriggerCategoryFor("Conditions"),
    event = "Conditions",
    use_alwaystrue = true}}}
});
...
tinsert(templates.general.args, {
  ...
  triggers = {[1] = { trigger = {
    type = M33Auras.GetTriggerCategoryFor("Pet Behavior"),
    event = "Pet Behavior",
    use_behavior = true,
    behavior = "assist"}}}
});
...
for i = 1, 4 do
  ...
  tinsert(templates.class.DRUID[i][resourceSection].args, {
    ...
    icon = 132276,
    triggers = {[1] = { trigger = {
      type = M33Auras.GetTriggerCategoryFor("Stance/Form/Aura"),
...
for i = 1, 3 do
  ...
  tinsert(templates.class.DEATHKNIGHT[i][resourceSection].args, {
    ...
    triggers = {[1] = { trigger = {
      type = M33Auras.GetTriggerCategoryFor("Death Knight Rune"),
